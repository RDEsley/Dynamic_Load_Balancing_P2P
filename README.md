...
[ASYNC] Conexão iniciada com ('0.0.0.0', 52341)
[TASK DISTRIBUIDA] Worker LOCAL - ('0.0.0.0', 52341) - USER: Michel
...
NEIGHBOR_MASTERS=B=0.0.0.0:8001
NUM_TASKS=120
...
NEIGHBOR_MASTERS=A=0.0.0.0:8000
